...
UnityExternCall(bool, UnityiOSVersionIsAtLeast, uint32_t, uint32_t);
...
UnityExternCall(void,               UnityEngineDidQuit, unsigned);
...
UnityExternCall(MTLTextureRef,  AcquireSwapchainDrawable, UnityViewSwapchain*);
