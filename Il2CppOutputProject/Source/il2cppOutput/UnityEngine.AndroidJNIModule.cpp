...
IL_0047:
	...
	try
	{
		...
		}
		{
			...
			L_25 = VirtualFuncInvoker1< MethodInfoU5BU5D_tDF3670604A0AECF814A0B0BA09B91FBF0D6A3265*, int32_t >::Invoke(105, L_23, L_24);
			V_12 = L_25;
			V_13 = 0;
...
IL_02f8:
	...
	}
	{
		...
		NullCheck(L_115);
		int32_t L_116;
		L_116 = VirtualFuncInvoker0< int32_t >::Invoke(48, L_115);
...
IL_032d:
	{
		...
		NullCheck(L_123);
		Type_t* L_124;
		L_124 = VirtualFuncInvoker0< Type_t* >::Invoke(47, L_123);
		il2cpp_codegen_runtime_class_init_inline(_AndroidJNIHelper_tA796944DDB1B1459DF68C9FFA518F452C81364F3_il2cpp_TypeInfo_var);
		String_t* L_125;
