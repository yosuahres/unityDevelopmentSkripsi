    ...
    public class SwiftUIDriver : MonoBehaviour
    {
        ...
        static void CallbackFromNative(string command, int value)
        {
            ...
            try
            {
                ...
                if(command == "TriggerConfigurationScene")
                {
                    self.TriggerConfigurationScene();
                    CloseSwiftUIWindow("HomeView");
                }
        ...
        public void TriggerConfigurationScene()
        
        {
            Debug.Log("TriggerConfigurationScene called from Swift!");
            // switch to configuration scene
            SceneManager.LoadScene("GUIConfigurationScene");
        }
    }
}
