...
public static class Fragmenter
{
    ...
    /// <param name="parent">The parent transform for the fragment objects</param>
    /// <returns></returns>
    public static GameObject[] Slice(GameObject sourceObject,
                             Vector3 sliceNormal,
                             Vector3 sliceOrigin,
                             ...
                             Transform parent)
    {
        ...
        GameObject fragmentA = CreateFragment(topSlice,
                                            sourceObject,
                                            fragmentTemplate,
                                            parent,
                                            false,
        ...
        GameObject fragmentB = CreateFragment(bottomSlice,
                                            sourceObject,
                                            fragmentTemplate,
                                            parent,
                                            false,
        ...
        return new GameObject[] { fragmentA, fragmentB };
    }
                                       ...
                                       ref int i)
    {
        ...
        {
            fragment = GameObject.Instantiate(fragmentTemplate, parent);
